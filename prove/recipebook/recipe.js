...
function search() {
  ...
  let sortedRecipes = filterRecipes.sort(compareHikes);
...
// Template to insert recipe into html.
...
// Template to add tags to html.
function tagTemplate(tags) {
    return tags.map((tag)=> `<button class="button" type="button">${tag}</button>`).join(' ');
}

// Template to add stars to html.
